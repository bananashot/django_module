...
class Purchase(models.Model):
    user = models.ForeignKey(ShopUser, on_delete=models.DO_NOTHING)
    products = models.ForeignKey(Products, on_delete=models.DO_NOTHING, related_name='product')
...
class Return(models.Model):
    declined_product = models.ForeignKey(Purchase, on_delete=models.DO_NOTHING)
